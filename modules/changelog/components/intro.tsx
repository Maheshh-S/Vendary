  ...
  return (
    <>
      ...
      <p className="mt-4 text-sm/6 text-gray-300 text-justify">
        Vendary is your gateway to India&apos;s rich artistic heritage. We connect you with genuine, handcrafted products at fair prices, directly supporting local artisans and preserving historical traditions. No middlemen, no inflated costs—just authentic craftsmanship, delivered with integrity.
      </p>
