...
-- CreateEnum
CREATE TYPE "Avaiavility" AS ENUM ('IN_STOCK', 'OUT_OF_STOCK', 'PRE_ORDER');
...
CREATE TABLE "Product" (
    ...
    "avaiavility" "Avaiavility" NOT NULL DEFAULT 'OUT_OF_STOCK',
    "shippingTime" TEXT NOT NULL DEFAULT '7-10 business days',
